  ...
  <div class="row-xs-height">
	<div class="col-xs-height col-middle">
	  <div class="error-container text-center">
		<h1 class="error-number"><img src="<?php print site_url('assets/img/logo.png'); ?>" alt="logo" data-src="<?php print site_url('assets/img/logo.png'); ?>" data-src-retina="<?php print site_url('assets/img/logo.png'); ?>" width="190" height="45"></h1>
		<h2 class="semi-bold">Registration completed successfully.</h2>
	...
	<div class="error-container-innner">
	  <div class="m-b-30 sm-m-t-20 sm-p-r-15 sm-p-b-20 clearfix">
		<!--<div class="col-sm-3 no-padding">
		  <img alt="" class="m-t-5" data-src="<?php print site_url('assets/img/logo.png'); ?>" data-src-retina="<?php print site_url('assets/img/logo.png'); ?>" height="60" src="<?php print site_url('assets/img/logo.png'); ?>" width="60">
		</div>
